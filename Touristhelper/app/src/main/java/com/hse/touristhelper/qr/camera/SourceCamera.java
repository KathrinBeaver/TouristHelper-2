...
public class SourceCamera {
    ...
    public static class Builder {
        ...
        private SourceCamera mSource = new SourceCamera();
    ...
    public SourceCamera start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
    ...
    @RequiresPermission(Manifest.permission.CAMERA)
    public SourceCamera start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
